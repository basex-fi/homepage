    ...
    >
      ...
      >
        ...
        <Box w={{ base: "full", md: "50%" }}>
          ...
          <Text mt={3}>
            BaseX leverages the scalability of Base Chain, Coinbase's L2 network
            built on Ethereum, to reduce gas costs and increase throughput. With
            the power of UniSwap V3 CLMM and our liquidity management partners,
            you can swap tokens with less slippage and more efficiency.
          </Text>
      ...
      >
        ...
        <Box w={{ base: "full", md: "50%" }}>
          ...
          <Link href="https://app.basex.fi/pools" target="_bank">
            <Button
              mt={4}
              variant="unstyled"
              color="#0049ff"
      ...
      >
        ...
        <Box w={{ base: "full", md: "50%" }}>
          ...
          <Text mt={3}>
            ...
            Ethereum L1, Coinbase, and other EVM chains. By utilizing the ve
            (3,3) mechanism, BaseX can create a positive feedback loop that
            increases the liquidity and value of the protocols on Base Chain.
          </Text>
          <Link href="https://app.basex.fi/gauges" target="_bank">
            <Button
              mt={4}
              variant="unstyled"
              color="#0049ff"
